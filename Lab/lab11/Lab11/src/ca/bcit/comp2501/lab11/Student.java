package ca.bcit.comp2501.lab11;
...
public class Student
{
    ...
    private int checkBirthYear(final String testString)
    {
        ...
        if(testString != null)
        {
            ...
            if(Integer.parseInt(testString) < EARLIEST_POSSIBLE_BIRTH_YEAR || Integer.parseInt(testString) > CURRENT_YEAR)
            {
     ...
     */ public String toString()
    {
        return "Student [firstName=" + this.firstName
                ...
                + ", gradePct=" + this.percentageGrade + " pass=" + pass + "]";
    }
}
