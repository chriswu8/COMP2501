...
public class BookStore
{
     ...
     */
    public static void printNameStartsEndsWith(final String substring) throws IllegalNameException
    {
        if(substring == null || substring.isBlank())
        {
        ...
        for(Novel novel : novels)
        {
            if(novel != null)
            {
                ...
                {
                    if(novel.getAuthor().toLowerCase().startsWith(substring.toLowerCase()) || novel.getAuthor().toLowerCase().endsWith(substring.toLowerCase()))
                    {
...
//        System.out.println(bookstore1.getLongest("titlE"));
        ...
        try
        {
            ...
            printTitlesContaining(null, false);
            printTitlesContaining("   ", false);

            printTitlesOfLength(0);
            printTitlesOfLength(-1);
